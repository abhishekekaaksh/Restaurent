...
public class ApiClient {
    ...
    public static final String TEMP_BASE_URL = "https://ekaakshgroup.in/FoodDeliverySystem/api/";
    public static final String TEMP_BASER_URL = "https://www.ekaakshgroup.in/FoodDeliverySystem/food/api/";
